...
export const constantRoutes = [
  ...
  //       component: () => import('@/views/build/index'),
  //       name: 'Build',
  //       meta: { title: 'Build', icon: 'guide', noCache: true }
  //     }
  //   ]
  // },
  {
...
export const asyncRoutes = [
  {
    ...
    children: [
      {
        path: 'index',
        component: () => import('@/views/gStoreSetting/index'),
        name: 'Icons',
        meta: { title: 'NodeSetting', icon: 'icon', noCache: true }
      }
    ]
  },
    ...
    children: [
      {
        ...
        component: () => import('@/views/icons/index'),
        name: 'Icons',
        meta: { title: 'Query', icon: 'icon', noCache: true }
      }
    ]
  },
