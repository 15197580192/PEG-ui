  ...
  >
    ...
    >
      <el-row>
        ...
        <el-col :span="24"
        >
          <el-form-item label="dbpath" prop="dbpath">
            <el-input
              placeholder="dbpath"
    ...
    <span slot="footer" class="dialog-footer">
      <el-button type="primary" @click="dataFormSubmit()" :disabled="loading">Create</el-button>
      <el-button @click="closeDialog" :disabled="loading">Cancel</el-button>
    </span>
